<style>
		...
		<h1>Recommended WordPress Plugins From Wpshopmart</h1>
				...
				<div class="col-md-12">
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank" title="Coming Soon Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/csp.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/colorbox-pro/" target="_blank" title="ColorBox Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/cb.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/accordion-pro/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/ac.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
									<h3>Accordion Pro </h3>
									<span class="price"><span class="amount"></span></span>
									<div class="wpsm-btn-block" style="">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/tabs-pro-plugin/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/tabs-pro.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
									<h3>Tabs Pro </h3>
									<span class="price"><span class="amount"></span></span>
									<div class="wpsm-btn-block" style="">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/service-showcase-pro-plugin-wordpress/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/service-pro.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
									<h3>Team Pro </h3>
									<span class="price"><span class="amount"></span></span>
									<div class="wpsm-btn-block" style="">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/counter-numbers-pro/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_service_box_directory_url.'assets/images/counters.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
