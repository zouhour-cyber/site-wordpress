...
function vw_gardening_landscaping_admin_theme_style() {
   ...
   wp_enqueue_style('vw-gardening-landscaping-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('vw-gardening-landscaping-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_gardening_landscaping_open_tab(event, 'gardening_lite')"><?php esc_html_e( 'Getting Started', 'vw-gardening-landscaping' ); ?></button>		  
