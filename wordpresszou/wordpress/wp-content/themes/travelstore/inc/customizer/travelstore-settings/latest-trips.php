<?php
/**
 * This file has the settings for the latest trips options.
 *
 * @package travelstore
 */
...
if ( ! function_exists( 'travelstore_customizer_settings_latest_trips' ) ) {
	 ...
	 */
	function travelstore_customizer_settings_latest_trips( $wp_customize ) {
		...
		travelstore_register_option(
			...
			array(
				...
				'description'       => esc_html__( 'If no taxonomy is selected, It will display the latest trips from all categories.', 'travelstore' ),
		...
		if ( function_exists( 'WP_Travel' ) ) {
			$btn_link_description = __( 'Select "Default" for selected page or post id link, "Trip Archives" for WP Travel archives link or "Custom Link" for CTA custom link.', 'travelstore' );
			$btn_link_choices     = array(
				'default'      => __( 'Default', 'travelstore' ),
				'trip_archive' => __( 'Trip Archives', 'travelstore' ),
				'custom'       => __( 'Custom Link', 'travelstore' ),
			);
		} else {
			$btn_link_description = __( 'Select "Default" for selected page or post id link, "Custom Link" for CTA custom link.', 'travelstore' );
			$btn_link_choices     = array(
				'default' => __( 'Default', 'travelstore' ),
				'custom'  => __( 'Custom Link', 'travelstore' ),
			);
		...
		travelstore_register_option(
			...
			array(
				...
				'description'       => esc_html( $btn_link_description ),
				'sanitize_callback' => 'travelstore_sanitize_select',
				'active_callback'   => function() {
					$panel_id     = 'travelstore_settings';
					$section_id   = 'travelstore_customizer_settings_latest_trips';
	...
	add_action( 'customize_register', 'travelstore_customizer_settings_latest_trips' );
}
