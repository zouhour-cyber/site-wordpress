...
if ( ! function_exists( 'travelstore_customizer_settings_featured_trips' ) ) {
	 ...
	 */
	function travelstore_customizer_settings_featured_trips( $wp_customize ) {
	...
	add_action( 'customize_register', 'travelstore_customizer_settings_featured_trips' );
}
